...
- Это руководство охватывает обновление с v1.x на v2.x (текущая версия: **2.0.1-dev.2**).
...
| v2.0.1-dev.2 | `/usr/bin/arxsentinel` | `/etc/arxsentinel/config.yaml` | Да | Активная разработка — см. [Releases](https://github.com/mr-addams/arxsentinel/releases) |
